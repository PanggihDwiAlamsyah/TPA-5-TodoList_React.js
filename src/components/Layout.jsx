...
const Layout = () => {
  ...
  return (
    <div className="container mx-auto mt-20 px-4">
      <h1 className=" text-center text-white font-bold text-4xl mb-16">What's the plan for today?</h1>
      <form className="flex gap-2 mb-12" onSubmit={handleCreateTodo}>
        <input 
          ...
          className="p-2 w-full border-black-100 border-solid border-2 rounded"
        />
        ...
        <ul className="flex justify-center gap-3">
          <li>
            <NavLink
              ...
              : "rounded-full text-black font-medium text-sm px-3.5 py-0.5  bg-gradient-to-r from-violet-200 to-blue-950"
              }
            >
              ALL
            </NavLink>
